        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="project-details" v-show="projectToView == 'YSJ'">
              <img src="../assets/ysj_bg.png" alt="YSJ" class="project-bg" />
              <div class="row">
                <div class="col-lg-9">
                  <div class="overview">
                    <div class="logo">
                      <img
                        src="../assets/ysj_logo.png"
                        alt="YSJ"
                        class="color"
                      />
                      <p>
            ...
            <div class="project-details" v-show="projectToView == 'IYNA'">
              <img src="../assets/iyna_bg.png" alt="IYNA" class="project-bg" />
              <div class="row">
                <div class="col-lg-9">
                  <div class="overview">
                    <div class="logo">
                      <img
                        src="../assets/iyna_logo.png"
                        alt="IYNA"
                        class="color"
                      />
                      <p>
            ...
            <div class="project-details" v-show="projectToView == 'HackClub'">
              <img src="../assets/hc_bg.png" alt="IYNA" class="project-bg" />
              <div class="row">
                <div class="col-lg-9">
                  <div class="overview">
                    <div class="logo">
              ...
              <div class="row">
                <div class="col-lg-9">
                  <div class="overview">
                    <div class="logo">
                      <img
                        src="../assets/enrevisions_logo.png"
              ...
              <div class="row">
                <div class="col-lg-9">
                  <div class="overview">
                    <div class="logo">
                      <img
                        src="../assets/greenhesive_logo.png"
                        alt="Kilecy"
                        class="color"
                      />
                      <p>
